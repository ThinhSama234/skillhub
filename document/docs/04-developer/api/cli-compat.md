...
SkillHub provides a ClawHub CLI protocol compatibility layer, allowing existing tools to migrate seamlessly.
...
### One-Click Copy from Frontend

The skill detail page on the SkillHub web interface automatically displays the install command with the correct environment variables — just copy and use it directly.
...
- [System Architecture](../architecture/overview) - Learn about the architectural design
